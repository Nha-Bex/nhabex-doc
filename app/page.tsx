    ...
    <>
      <div className="mx-auto">
        ...
        <p className="mb-4 mt-4">
          O NhaBex é uma plataforma inovadora que oferece soluções integradas
          para gestão de filas, pagamentos, agendamentos, marketplace,
          publicidade e muito mais. Desenvolvido para otimizar a experiência dos
          usuários e empresas, o NhaBex permite automação, agilidade e
 ...
 */}
        ...
        <Carousel className="w-full overflow-hidden">
          ...
          <CarouselContent className="flex gap-4 justify-start">
            {solucoes.map((solucao, index) => (
              <CarouselItem
                key={index}
                className="flex-none w-60 sm:w-64 md:w-72 p-2"
              >
                <div className="p-4 rounded-lg shadow-lg flex flex-col items-center">
                  ...
                  <Link href={solucao.link} passHref>
                    <Button className="mt-2 w-full bg-[#3CBDA1]">
                      Saber mais
                    </Button>
                  </Link>
                </div>
        ...
        <p className="mb-4">
          Para começar com nossa documentação, navegue pelas seções usando a
          barra lateral à esquerda. Aqui está uma rápida visão geral das seções
          disponíveis:
        </p>
        <ul className="mb-4 list-inside list-disc space-y-1">
          <li>
          ...
          <li>
            <strong>Soluções</strong>: Explore as soluções disponíveis e como
            usá-los
          </li>
          <li>
        ...
        <p className="mb-4">
          Caso tenha alguma dúvida ou precise de mais assistência, não hesite em
